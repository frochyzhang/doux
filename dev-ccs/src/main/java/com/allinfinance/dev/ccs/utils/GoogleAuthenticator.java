...
//    1qaz2wsx3edc4rfv5tgb6yhn7ujm8kas

//    2wsx3edc4rfv5tgb2wsx3edc4rfv5tgb
...
//        String cuiwy = qrImageUrl("cuiwy", "2wsx3edc4rfv5tgb2wsx3edc4rfv5tgb");
    ...
    public static String generateOtpAuthUrl(String keyId, String secret, String issuer) {
        StringBuilder sb = new StringBuilder();
        addOtpAuthPart(keyId, secret, issuer, sb);
        return sb.toString();
    }
    ...
    private static void addOtpAuthPart(String keyId, String secret, String issuer, StringBuilder sb) {
        sb.append("otpauth://totp/").append(keyId).append("?secret=").append(secret).append("&issuer=").append(issuer);
    }
