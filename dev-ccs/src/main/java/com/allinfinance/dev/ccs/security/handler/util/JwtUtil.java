package com.allinfinance.dev.ccs.security.handler.util;
...
public class JwtUtil {
     ...
     * @return token中包含的用户角色
     */
    public static String getWeight(String token) {
        try {
            DecodedJWT jwt = JWT.decode(token);
            return jwt.getClaim("weight").asString();
        } catch (JWTDecodeException e) {
            return null;
        }
    }
     ...
     * @return
     */
    public static String sign(String userName, String userId, String role, String org, String weight) {
        //过期时间
        Date date = new Date(System.currentTimeMillis() + EXPIRE_TIME);
        setExpireEndTime(date.getTime());
        return sign(userName, userId, role, org, weight, date);
    }
     ...
     * @return
     */
    public static String signRefresh(String userName, String userId, String role, String org, String weight) {
        return sign(userName, userId, role, org, weight, new Date(System.currentTimeMillis() + EXPIRE_TIME));
    }
     ...
     * @return 加密的token
     */
    public static String sign(String userName, String userId, String role, String org, String weight, Date date) {
        try {
//
//            私钥及加密算法
