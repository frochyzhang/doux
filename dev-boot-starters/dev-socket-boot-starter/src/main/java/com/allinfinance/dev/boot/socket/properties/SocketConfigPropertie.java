 ...
 * @date
 */
@ConfigurationProperties("com.allinfinance.dev.common.socket")
public class SocketConfigPropertie {
    /**
     * 监听应用名
     */
    private String name;
     ...
     * 报文解码处理类
     */
    private String decoderClassName = "com.allinfinance.dev.common.socket.codec.DemuxingMessageDecoder";
    /**
     * 报文编码处理类
     */
    private String encoderClassName = "com.allinfinance.dev.common.socket.codec.DemuxingMessageEncoder";
    /**
     * 是否开启soLinger开关
     */
