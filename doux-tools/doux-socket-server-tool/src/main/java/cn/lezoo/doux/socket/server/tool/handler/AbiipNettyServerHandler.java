...
/**
 * @author huanghf
 * @date 2024/7/26 10:42
 */
@Slf4j
@RequiredArgsConstructor
public class AbiipNettyServerHandler extends ChannelInboundHandlerAdapter {
    private final String name;

    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        log.info("收到请求：{}", msg);
        String serviceId = XmlUtils.getValueWithoutLabel((String) msg, "SERVICE_ID");
        String resXml = "";
        switch (serviceId) {
            case "12000":
