 ...
 */
@ConfigurationProperties(prefix = "cn.lezoo.backup")
@NacosConfigurationProperties(groupId = Constants.DEFAULT_GROUP, prefix = "cn.lezoo.backup", dataId = "white-list-config",
