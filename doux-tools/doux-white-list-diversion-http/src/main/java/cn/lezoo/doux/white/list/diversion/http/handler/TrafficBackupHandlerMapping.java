...
import cn.lezoo.doux.white.list.diversion.http.backup.BackupInfo;
import cn.lezoo.doux.white.list.diversion.http.backup.MessageInfo;
import cn.lezoo.doux.white.list.diversion.http.backup.TradeDirection;
import cn.lezoo.doux.white.list.diversion.http.config.BackupFlagContext;
import cn.lezoo.doux.white.list.diversion.http.config.RequestBodyRequestWrapper;
import cn.lezoo.doux.white.list.diversion.http.config.TrafficBackupConfig;
import cn.lezoo.doux.white.list.diversion.http.service.HttpRequestDTO;
import cn.lezoo.doux.white.list.diversion.http.service.TrafficBackupService;
import cn.lezoo.doux.white.list.diversion.http.util.RequestMsgUtils;
import cn.lezoo.doux.white.list.diversion.http.util.TrafficBackupUtils;
            ...
            public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
                try {
                    ...
                    if (trafficBackupService == null) {
                        throw new RuntimeException("Traffic backup required a bean of type 'cn.lezoo.doux.white.list.diversion.http.service.TrafficBackupService' that could not be found.");
                    }
