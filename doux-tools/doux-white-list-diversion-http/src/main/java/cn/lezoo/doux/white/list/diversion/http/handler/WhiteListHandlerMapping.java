...
import cn.lezoo.doux.white.list.diversion.http.client.ForwardClientService;
import cn.lezoo.doux.white.list.diversion.http.config.ForwardFlagContext;
...
import cn.lezoo.doux.white.list.diversion.http.service.WhiteListService;
            ...
            public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
                try {
                    ...
                    if (whiteListService == null) {
                        throw new RuntimeException("White list diversion required a bean of type 'cn.lezoo.doux.white.list.diversion.http.service.WhiteListService' that could not be found.");
                    }
