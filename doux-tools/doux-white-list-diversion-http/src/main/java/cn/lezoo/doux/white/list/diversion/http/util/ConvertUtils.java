package cn.lezoo.doux.white.list.diversion.http.util;
...
public class ConvertUtils {
    ...
    public static final Set<String> TRUE_SET = new LinkedHashSet<>(Arrays.asList("y", "yes", "on", "true", "t"));

    public static final Set<String> FALSE_SET = new LinkedHashSet<>(Arrays.asList("n", "no", "off", "false", "f"));
