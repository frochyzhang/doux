...
public class ServerMetadata {
     ...
     * @return
     */
    public AbstractClientConnection fetchConnection(int bufferSize, int lengthFiled, int requestTimeout) {
        ...
        abstractClientConnection.setRequestTimeout(requestTimeout);
