package com.allinfinance.dev.dispatch.scaffold;

import com.allinfinance.dev.dispatch.scaffold.config.JobExecutorProperties;
...
public class DispatchScaffoldConfiguration {
    public static final String SCAFFOLD_BASE_PACKAGE_PREFIX = "com.allinfinance.dev.dispatch.scaffold";
