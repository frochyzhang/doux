...
public class PooledConnection implements InvocationHandler {
    ...
    private final PooledServerMetadata metadata;
     ...
     * @param metadata   - the dataSource that the connection is from
     */
    public PooledConnection(Connection connection, PooledServerMetadata metadata) {
    ...
    public boolean isValid() {
        return valid && realConnection != null && metadata.pingConnection(this);
    }
