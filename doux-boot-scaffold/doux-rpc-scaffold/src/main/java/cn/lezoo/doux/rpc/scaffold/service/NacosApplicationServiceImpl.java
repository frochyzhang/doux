package cn.lezoo.doux.rpc.scaffold.service;

import cn.lezoo.doux.rpc.scaffold.api.NacosApplicationService;
 ...
 * @Date: 2022/3/24
 **/
@ConditionalOnProperty(value = "cn.lezoo.rpc.nacos.config.enabled", havingValue = "true")
