 ...
 */
@ConfigurationProperties(prefix = "cn.lezoo.rpc.gateway")
public class Bootstrap {

    public static final String BOOT_ENABLE = "cn.lezoo.rpc.bootstrap.enable";
    ...
    public static class AppConfigList implements Serializable {
        ...
        public static class TcpConfig implements Serializable {
             ...
             * 业务处理类
             */
            private String handlerClassName = "cn.lezoo.doux.gateway.util.DefaultTcpIOHandler";
            /**
             * 报文解码处理类
             */
            private String decoderClassName = "cn.lezoo.doux.core.util.socket.codec.DemuxingMessageDecoder";
            /**
             * 报文编码处理类
             */
            private String encoderClassName = "cn.lezoo.doux.core.util.socket.codec.DemuxingMessageEncoder";
            /**
             * 是否开启soLinger开关
             */
