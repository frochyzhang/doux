package cn.lezoo.doux.connection.pool.scaffold.util;
...
public class StopWatchExpand {
    ...
    public static String prettyPrint() {
        ...
        // 编写总结
        String shortSummary = "StopWatch '" + stopWatch.getId() + "': running time [ " + String.format("%9s", totalTimeMillis) + "ms / " + String.format("%9.3f", totalTimeSeconds) + "s ]";
