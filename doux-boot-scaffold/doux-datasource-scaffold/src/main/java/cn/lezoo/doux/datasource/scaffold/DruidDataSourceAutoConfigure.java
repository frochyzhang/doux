 ...
 */
package cn.lezoo.doux.datasource.scaffold;

import cn.lezoo.doux.datasource.scaffold.config.DatasourceEncryptProperties;
import cn.lezoo.doux.datasource.scaffold.properties.DruidStatProperties;
import cn.lezoo.doux.datasource.scaffold.stat.DruidFilterConfiguration;
import cn.lezoo.doux.datasource.scaffold.stat.DruidSpringAopConfiguration;
import cn.lezoo.doux.datasource.scaffold.stat.DruidStatViewServletConfiguration;
import cn.lezoo.doux.datasource.scaffold.stat.DruidWebStatFilterConfiguration;
...
public class DruidDataSourceAutoConfigure {
    public static final String SCAFFOLD_BASE_PACKAGE_PREFIX = "cn.lezoo.doux.datasource.scaffold";
