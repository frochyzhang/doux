 ...
 * the License.
 */
package cn.lezoo.doux.disruptor.template;
...
public class DisruptorTemplate {
    ...
    public DisruptorTemplate(Disruptor<DisruptorEvent> disruptor,
    ...
    public void publishEvent(String eventKey, Object data) {
        DisruptorEvent bindEvent = new DisruptorEvent();
        bindEvent.setEventKey(eventKey);
        bindEvent.setData(data);
