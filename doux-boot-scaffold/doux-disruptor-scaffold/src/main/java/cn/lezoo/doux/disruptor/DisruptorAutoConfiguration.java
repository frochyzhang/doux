...
import cn.lezoo.doux.disruptor.hook.DisruptorShutdownHook;
import cn.lezoo.doux.disruptor.processor.EventProcessorFactory;
...
@ComponentScan(basePackages = "cn.lezoo.doux.disruptor")
@Configuration
...
public class DisruptorAutoConfiguration {
    ...
    public Disruptor<DisruptorEvent> disruptor(
        ...
        ExecutorService executorService =
                Executors.newFixedThreadPool(properties.getRingThreadNumbers(), threadFactory);
        // 使用disruptor创建消费者组
