 ...
 */
public class HspMessageDecoder implements MessageDecoder {
    private static final Logger logger = LoggerFactory.getLogger(HspMessageDecoder.class);

    private Integer msgLengthSize;
    private String msgEncode;

    public HspMessageDecoder() {
        this.msgLengthSize = 0;
        this.msgEncode = "UTF-8";
    }

    public HspMessageDecoder(Integer msgLengthSize, String msgEncode) {
