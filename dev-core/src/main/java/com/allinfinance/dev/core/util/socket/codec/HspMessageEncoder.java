 ...
 */
public class HspMessageEncoder implements MessageEncoder<String> {

    private static Logger logger = LoggerFactory.getLogger(HspMessageEncoder.class);
    ...
    public HspMessageEncoder(Integer msgLengthSize, String msgEncode) {
