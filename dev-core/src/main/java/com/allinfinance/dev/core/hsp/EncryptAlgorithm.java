...
public enum EncryptAlgorithm {
     ...
     * @author zhangyong
     */
    public static interface HsmCommand {

        /**
         * 密钥转换，将ZMK加密的密钥转换为LMK加密的密钥
         *
         * @param keyType  密钥类型
         * @param zmkIndex ZMK索引
         * @param key      待转换的密钥
         * @return 转换后的密钥
         * @throws Exception        加密机返回的异常
         * @throws ConnectException 加密机连接异常
         */
         ...
         * 计算MAC
         *
         * @param key 由LMK加密的工作密钥
         * @param mab 计算MAC所用的数据块
         * @return 计算得到的MAC
         * @throws Exception        加密机返回的异常
         * @throws ConnectException 加密机连接异常
         */
         ...
         * 计算PINOFFSET
         *
         * @param cardNo   介质卡号16位，使用时需要进行截取
         * @param pinBlock pin值
         ...
         * @param srcKey         源工作密钥
         * @param destKey        目标工作密钥
         * @param srcFormat(无用)  源格式 (0x01:带主帐号的ANSI9.8格式 0x02: Docutel ATM； 0x03: Diebold and
         *                       IBM ATM,； 0x04: Plus Network； 0x05: ISO9564-1-1格式，1NP..PR...R
         *                       0x06:不带主帐号的ANSI9.8格式 )
         * @param destFormat(无用) 目标格式 (0x01:带主帐号的ANSI9.8格式 0x02: Docutel ATM； 0x03: Diebold and
         *                       IBM ATM,； 0x04: Plus Network； 0x05: ISO9564-1-1格式，1NP..PR...R
         *                       0x06:不带主帐号的ANSI9.8格式 )
         * @param srcPIN         PIN数据块
         * @param srcAccount     源账号
