...
import cn.lezoo.doux.common.dictionary.desensitized.processor.DesensitizedFactory;
import cn.lezoo.doux.common.dictionary.logger.LogUtil;
...
public class DesensitizedHelperImpl implements DesensitizedHelper {
    ...
    @Value("${cn.lezoo.epcc.desensitized.packageSuffix:}")
