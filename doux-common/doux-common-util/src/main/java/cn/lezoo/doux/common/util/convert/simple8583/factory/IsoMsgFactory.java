package cn.lezoo.doux.common.util.convert.simple8583.factory;


import cn.lezoo.doux.common.util.convert.simple8583.model.IsoField;
import cn.lezoo.doux.common.util.convert.simple8583.model.IsoPackage;
import cn.lezoo.doux.common.util.convert.simple8583.util.EncodeUtil;
import cn.lezoo.doux.common.util.convert.simple8583.util.encrypt.TripleDES;
...
public class IsoMsgFactory extends AbstractIsoMsgFactory {
    ...
    protected byte[] mac(IsoPackage isoPackage) throws Exception {
        String[] md5Array = {"2", "3", "4", "11", "12", "13", "49", "38", "39", "41"};
    ...
    protected byte[] msgLength(int length) {
        ...
        // return rByte;
        String len = length + "";
        len = new String(EncodeUtil.addBlankLeft(len, 4 - len.length(), "0").getBytes());
    ...
    protected void macValidate(IsoPackage isoPackage, Map<String, String> map) {
        ...
        // Binary编码转换为hex编码
        String returnMac = EncodeUtil.hex(EncodeUtil.binary(map.get("64")));
        assert mac != null;
