...
import cn.lezoo.doux.framework.conn.wrapper.pool.util.DriverDataSource;
import cn.lezoo.doux.framework.conn.wrapper.pool.util.PropertyElf;
import cn.lezoo.doux.framework.conn.wrapper.pool.util.UtilityElf;
import cn.lezoo.doux.framework.conn.wrapper.pool.util.UtilityElf.DefaultThreadFactory;
...
import static cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyConnection.*;
import static cn.lezoo.doux.framework.conn.wrapper.pool.util.ClockSource.*;
import static cn.lezoo.doux.framework.conn.wrapper.pool.util.UtilityElf.createInstance;
...
abstract class PoolBase
{
   ...
   private static final int MINIMUM_LOGIN_TIMEOUT = Integer.getInteger("cn.lezoo.doux.framework.conn.wrapper.pool.minimumLoginTimeoutSecs", 1);
