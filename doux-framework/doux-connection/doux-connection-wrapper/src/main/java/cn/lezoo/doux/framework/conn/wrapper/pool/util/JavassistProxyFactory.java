...
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyCallableStatement;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyConnection;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyDatabaseMetaData;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyFactory;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyPreparedStatement;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyResultSet;
import cn.lezoo.doux.framework.conn.wrapper.pool.impl.ProxyStatement;
...
public final class JavassistProxyFactory
{
   ...
   private static void modifyProxyFactory() throws NotFoundException, CannotCompileException, IOException {
      System.out.println("Generating method bodies for cn.lezoo.doux.framework.conn.wrapper.pool.proxy.ProxyFactory");

      String packageName = ProxyConnection.class.getPackage().getName();
      CtClass proxyCt = classPool.getCtClass("cn.lezoo.doux.framework.conn.wrapper.pool.pool.ProxyFactory");
