...
import static cn.lezoo.doux.framework.conn.wrapper.pool.util.ConcurrentBag.IConcurrentBagEntry.STATE_REMOVED;
import static cn.lezoo.doux.framework.conn.wrapper.pool.util.ConcurrentBag.IConcurrentBagEntry.STATE_RESERVED;
...
import static cn.lezoo.doux.framework.conn.wrapper.pool.util.ConcurrentBag.IConcurrentBagEntry.*;
...
public class ConcurrentBag<T extends ConcurrentBag.IConcurrentBagEntry> implements AutoCloseable
{
   ...
   {
      try {
         if (System.getProperty("cn.lezoo.doux.framework.conn.wrapper.pool.useWeakReferences") != null) {   // undocumented manual override of WeakReference behavior
            return Boolean.getBoolean("cn.lezoo.doux.framework.conn.wrapper.pool.useWeakReferences");
         }
