 ...
 */
package cn.lezoo.doux.framework.extension.util;
...
public final class ExceptionUtils {
    ...
    public static RuntimeException buildRuntime(String configKey, String configValue) {
        String msg = "The value of config " + configKey + " [" + configValue + "] is illegal, please check it";
        return new RuntimeException(msg);
    }

    public static RuntimeException buildRuntime(String configKey, String configValue, String message) {
