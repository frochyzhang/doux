 ...
 *
 */
package com.allinfinance.dev.tools.hsp.util;
...
public class Sm2CertUtils {
    ...
    public static final Certificate certFrom(byte[] certData) throws Exception {
    ...
    public static byte[] getPublicKey(Certificate cert) {
