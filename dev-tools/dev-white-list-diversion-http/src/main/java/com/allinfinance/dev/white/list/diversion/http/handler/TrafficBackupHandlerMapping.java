...
import com.allinfinance.dev.white.list.diversion.http.backup.TrafficBackupUtils;
...
public class TrafficBackupHandlerMapping implements HandlerMapping {
    ...
    public TrafficBackupHandlerMapping(WhiteListConfig whiteListConfig, TrafficBackupService trafficBackupService) {
    ...
    public HandlerExecutionChain getHandler(HttpServletRequest request) throws Exception {
        ...
        if (!whiteListConfig.getBackupFlag()) {
        ...
        return new HandlerExecutionChain(new TrafficBackupHandler(), new HandlerInterceptor() {
            ...
            public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
                ...
                HttpRequestDTO httpRequestDTO = new HttpRequestDTO(requestURI, headers, body, method);
