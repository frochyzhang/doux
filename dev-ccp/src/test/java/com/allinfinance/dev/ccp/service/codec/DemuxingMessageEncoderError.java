package com.allinfinance.dev.ccp.service.codec;
 ...
 */
public class DemuxingMessageEncoderError extends MessageToByteEncoder<String> {

    private static final Logger logger = LoggerFactory.getLogger(DemuxingMessageEncoderError.class);
...
//    }
    ...
    public DemuxingMessageEncoderError(Integer msgLengthSize, String msgEncode) {
