...
/**
 * Implementation of {@link ICustomJobExplorer} using the injected DAOs.
 *
 * @author Dave Syer
 * @author Lucas Ward
 ...
 *
 * @see ICustomJobExplorer
 * @see JobInstanceDao
 * @see JobExecutionDao
 * @see StepExecutionDao
 * @since 2.0
 */
public class CustomJobExplorer implements ICustomJobExplorer {
	...
	public CustomJobExplorer(JobInstanceDao jobInstanceDao, JobExecutionDao jobExecutionDao,
